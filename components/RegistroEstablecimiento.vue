                ...
                <div class="login-form">
                    ...
                    <form @submit="formRegistroEstablecimiento" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="group">
                            ...
                            <label for="registroTelefonoEstablecimiento" class="label">Slug</label>
                        ...
                        <div class="group">
                            ...
                            <label for="registroTelefonoEstablecimiento" class="label">Link de Google Map</label>
...
.estiloSubirImg:hover,.estiloSubirImg:focus{
